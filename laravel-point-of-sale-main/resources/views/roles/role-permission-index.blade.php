                        ...
                        <div class="col">
                            <div class="dropdown">
                                <button class="modern-btn btn-panel-tab active w-100 mb-4 dropdown-toggle" type="button" id="rolesDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fas fa-user-shield"></i> Roles in Permissions
                                </button>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h2 class="mb-3" style="color: #02011a;">Role in Permission List</h2>
                </div>
                <div>
                    <a href="{{ route('rolePermission.create') }}" class="btn btn-primary add-list" style="border-radius: 2; background-color: #1f61d2; color: white; border: none;"><i class="fa-solid fa-plus mr-3"></i>Add Role in Permission</a>
                </div>
            </div>
        </div>
...
<style>
    ...
    .dropdown-item:hover {
        background-color: rgba(179, 188, 246, 0.05);
    }
</style>
