    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h2 class="mb-3" style="color: #02011a">Permission List</h2>
                ...
                <div>
                    <a href="{{ route('permission.create') }}" class="btn btn-primary add-list" style="border-radius: 2; background-color: #1f61d2; color: white; border: none;"><i class="fa-solid fa-plus mr-3"></i>Add Permission</a>
                </div>
            </div>
        </div>
