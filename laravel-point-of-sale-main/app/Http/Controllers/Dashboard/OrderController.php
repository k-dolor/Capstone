    ...
    public function completedOrders()
{
    ...
    return view('your.view.path', compact('completedOrders'));
}
/////////////////////////////////////////////////
    ...
    public function storeOrder(Request $request)
{
    // Validation rules
    $rules = [
        // Uncomment this line if you have customer ID handling
        // 'customer_id' => 'required|numeric',
        'payment_status' => 'required|string',
        'pay' => 'numeric|nullable',
    ];
    ...
    $validatedData['order_status'] = 'complete'; // Change to 'complete' as per your requirement
    $validatedData['total_products'] = Cart::count(); // Count of products in the cart
    $validatedData['sub_total'] = Cart::subtotal(); // Get subtotal from cart
    $validatedData['vat'] = Cart::tax(); // Get tax from cart
    $validatedData['invoice_no'] = $invoice_no; // Set the generated invoice number
    $validatedData['total'] = Cart::total(); // Get total amount from cart
    $validatedData['due'] = $validatedData['total'] - ($validatedData['pay'] ?? 0); // Calculate due
    $validatedData['created_at'] = Carbon::now(); // Current timestamp for creation
    ...
    // return Redirect::route('order.completeOrders')->with('success', 'Order has been created!');
...
public function showInvoice($orderId)
{
    ...
    $orderDetails = OrderDetails::where('order_id', $orderId)->get(); // Retrieve order details related to the order
